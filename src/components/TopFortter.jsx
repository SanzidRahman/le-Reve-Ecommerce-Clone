    ...
    <div className="flex-col px-4 xl:flex max-w-[980] mx-auto justify-evenly space-x-4">
      <div className="flex flex-col basis-[50%] mt-10">
        ...
        <p className="text-[10px] mt-2">
          ...
          value-conscious fashion for all, Le Reve creates a delightful shopping
          experience through its well-designed stores, providing a relaxed and
          pleasing atmosphere. Le Reve has become one of the most preferred
          online shopping destinations by delivering quality fashion through
      ...
      <div className="flex flex-col basis-[50%] mt-10 space-y-2">
        ...
        <input className="border border-gray-200 text-[12px] p-1" type="text" placeholder="Enter Your Email"></input>
        ...
        <button className="h-7 w-120 bg-yellow-300 text-center">Subcribe</button>
      </div>
    </div>
  );
};
